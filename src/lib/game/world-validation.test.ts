    ...
    locationTradeIdentity: [
      {
        ...
        supplyConditions: "Fuel boats are arriving late.",
        materialLife: "Dock crews barter for lamp time after dark.",
      },
      {
        locationId: "loc_archive",
        signatureGoods: ["sealed records"],
        supplyConditions: "Dry storage is more valuable than coin.",
        materialLife: "Copyists trade access, favors, and dry shelf space.",
      },
      {
        locationId: "loc_reef",
        signatureGoods: ["smuggled salt fish"],
        supplyConditions: "Patrol sweeps keep trade irregular.",
        materialLife: "Small crews trade fast and vanish before inspection.",
      },
    ],
  };
